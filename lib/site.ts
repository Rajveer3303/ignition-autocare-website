...
export const HOME_FAQS = [
  {
    q: "Where can I book an MOT in Castleford?",
    a: "You can book your MOT in Castleford directly with Ignition Autocare online or by phone. We provide DVSA-approved MOT testing with transparent pricing and free retests if required.",
  },
  {
    q: "How much does an MOT cost in Castleford?",
    a: "The cost of an MOT in Castleford varies, but at Ignition Autocare we keep it affordable with clear, upfront prices. Enter your vehicle registration online to get an instant MOT price for your car or van.",
  },
  {
    q: "Do you offer car servicing in Castleford?",
    a: "Yes, we provide interim, full, and major car servicing in Castleford for all makes and models. Regular servicing helps improve fuel efficiency, extend engine life, and avoid costly repairs later.",
  },
  {
...
export const TESTIMONIALS = [
  ...
  {
    name: "Susan",
    text: "Took my car for air con issues. Kevin diagnosed the problem and gave a good price. The staff are polite, friendly and professional. I would definitely use this garage again.",
  },
  {
    name: "Matt Syphus",
    text: "Good service, needed urgent MOT and they fit me in.",
  },
  {
    name: "Paul Green",
